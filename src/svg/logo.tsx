    ...
    return (
        ...
        >
            ...
            <g clipPath="url(#clip0)">
                ...
                <path
                    fill="#fff"
                    d="M24.5 35a3.5 3.5 0 100-7 3.5 3.5 0 000 7z"
                ></path>
                <path
                    fill="#2A2B8D"
                    d="M24.5 33a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"
                ></path>
            </g>
            <defs>
                <linearGradient
                ...
                >
                    <stop stopColor="#2A2B8D"></stop>
                    <stop offset="0.033" stopColor="#2B2F8F"></stop>
                    <stop offset="1" stopColor="#559BD1"></stop>
                </linearGradient>
                <clipPath id="clip0">
                    <path
                        fill="#fff"
